...
type Heart = { id: number; x: number; y: number; dx: number };

type Props = {
  spawnHearts: (e: MouseEvent<HTMLButtonElement>) => void;
  hearts: Heart[];
  tapMsg: string;
  onExperienceAgainReset: () => void;
  onSendKiss: () => void;
};

export default function FinalScreen({ spawnHearts, hearts, tapMsg, onExperienceAgainReset, onSendKiss }: Props) {
  return (
