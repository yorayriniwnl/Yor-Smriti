...
const FRAGMENT_WORDS = ['Sorry', 'Why?', 'Leave it', "It's nothing", 'Later', 'I am fine'];

const SMALL_THINGS = ['Late night talks', 'Random laughs', 'Stupid fights'];

const LETTER_PAGE_LINES = {
...
function useEmotionalScrollResistance(
...
function SymbolMotif({ kind }: { kind: SymbolKind }) {
  if (kind === 'light') {
    return (
      <motion.div
...
function SceneEyebrow({ text }: { text: string }) {
  return (
    <p
...
function MemoryEchoText({ text }: { text: string }) {
  return (
    <motion.p
      aria-hidden="true"
  ...
  return (
    ...
    >
      <div className="text-center">
        <SceneEyebrow text="screen 86 - the letter" />
...
export function Timeline88Screen({ emotion }: ExperienceScreenProps) {
  return (
    <section className="space-y-6">
      <div className="text-center">
        <SceneEyebrow text="screen 88 - the timeline" />
  ...
  return (
    <section className="relative flex min-h-[58vh] items-center justify-center overflow-hidden text-center">
      ...
      <div className="relative space-y-4">
        <SceneEyebrow text="screen 89 - the first crack" />
...
export function ThingsISaid90Screen({ emotion }: ExperienceScreenProps) {
  return (
    ...
    >
      ...
      <div className="relative space-y-4">
        <SceneEyebrow text="screen 90 - the things i said" />
...
export function Distance92Screen({ emotion }: ExperienceScreenProps) {
  return (
    <section className="relative flex min-h-[58vh] flex-col items-center justify-center gap-5 overflow-hidden text-center">
      ...
      <SceneEyebrow text="screen 92 - the distance" />
