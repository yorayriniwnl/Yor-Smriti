...
const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    eyebrow: 'portrait',
    title: 'Who She Is',
    description: 'A page written entirely about her — not how she makes him feel, but who she actually is.',
    emoji: '🌙',
    delay: 0.5,
    feeling: 'Not about him. Entirely about her.',
  },
  {
    href: '/questions',
    eyebrow: 'wondering',
    title: 'Things I Sit With',
    description: 'Questions he genuinely has — not rhetorical, not demanding. Real things he wonders.',
    emoji: '❓',
    delay: 0.6,
    feeling: 'Not demands. Just things he sits with quietly.',
  },
  {
    href: '/small-things',
    eyebrow: 'noticed',
    title: 'Things I Noticed',
    description: 'The tiny specific things about her he observed and never mentioned out loud.',
    emoji: '👁️',
    delay: 0.7,
    feeling: 'The proof that he was watching. All along.',
  },
  {
    href: '/before-after',
    eyebrow: 'growth',
    title: 'Then and Now',
    description: 'A split comparison — not of the relationship, but of him.',
    emoji: '🔄',
    delay: 0.8,
    feeling: 'The same person. Different choices.',
  },
  {
    href: '/gratitude',
    eyebrow: 'gratitude',
    title: "What I'm Grateful For",
    description: 'Specific ways she changed how he sees things, what he values, who he is.',
    emoji: '🙏',
    delay: 0.9,
    feeling: 'Not what he lost. What she gave him.',
  },
];
